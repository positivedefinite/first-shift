...
export const LEVELS = [
  {
    ...
    blurb: 'Quiet cul-de-sacs. Warm windows. First pedal out.',
    doorLabel: 'HOME',
    ...
    startTime: 68,
    obstacleStart: 90,
    obstacleGapEarly: [34, 22],
    obstacleGapLate: [24, 16],
    pickupStart: 40,
    pickupGap: [32, 22],
    musicBase: 0.2,
    theme: {
  ...
  },
  {
    ...
    startTime: 55,
    obstacleStart: 70,
    obstacleGapEarly: [28, 18],
    obstacleGapLate: [16, 14],
    pickupStart: 45,
    pickupGap: [36, 28],
    musicBase: 0.35,
    theme: {
