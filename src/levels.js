...
export const LEVELS = [
  {
    ...
    blurb: 'Warm windows. Wet hedges. The street still thinks you live here.',
    doorLabel: 'HOME',
  ...
  },
  {
    ...
    blurb: 'Terraces lean in. Canal black as glass. Someone expects you.',
    doorLabel: 'DOOR',
  ...
  },
  {
    ...
    name: 'DOWNTOWN',
    subtitle: 'Neon Mile',
    blurb: 'Neon eats the rain. The mile does not care if you are late.',
    doorLabel: 'TOWER',
  ...
  },
  {
    ...
    name: 'OLD TOWN',
    subtitle: 'Bell Lane',
    blurb: 'Stone remembers wheels. Bells wait. Do not linger under them.',
    doorLabel: 'GATE',
  ...
  },
  {
    ...
    name: 'WAY BACK',
    subtitle: 'The Span',
    blurb: 'Rain gone. Bridge home. The city keeps its distance on your left.',
    doorLabel: '—',
    debriefPhoto: '/debrief/debrief-wayback.png',
    ...
    traffic: { vanChance: 1, maxVans: 2, maxWalkers: 0 },
    pickupStart: 30,
    pickupGap: [22, 16],
    musicBase: 0.18,
    theme: {
      mode: 'wayback',
      brick: [0x1a2030, 0x2a2620, 0x121824, 0x322e28],
      neon: [0xff2d6a, 0x3de0ff, 0xffa050, 0xb44dff],
      neonChance: 0.4,
      shopChance: 0,
      storiesMin: 6,
      storiesMax: 12,
